...
if ( finwave_option( 'rt_blog_above_meta_visibility' ) && !empty( has_post_thumbnail() ) && !empty( $rt_post_gallerys_raw ) ) {
	...
	<div class="article-inner-wrapper <?php echo esc_attr($wow . ' ' . $effect); ?>" data-wow-delay="<?php echo esc_attr($delay); ?>ms" data-wow-duration="<?php echo esc_attr($duration); ?>ms">
		<div class="post-thumbnail-wrap">
			...
			<?php } else { ?>
				...
				<?php if ( finwave_option( 'rt_blog_above_meta_visibility' ) && !empty( has_post_thumbnail() )) { ?>
					<div class="posted-on">
				...
				if ( finwave_option( 'rt_video_visibility' ) == 1 && ( 'video' == get_post_format( get_the_ID() ) ) && !empty( $rt_youtube_link ) ) { ?>
		...
		<div class="entry-wrapper">
			<header class="entry-header">
				<?php if ( ! empty( $meta_list ) && finwave_option( 'rt_meta_visibility' ) ) {
